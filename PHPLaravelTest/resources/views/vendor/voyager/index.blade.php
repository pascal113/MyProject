...
@section('content')
    <div class="page-content" style="height: 90vh; background-image:url({{ asset('images/admin/dashboard-bg.png') }}); background-size: 33%; background-position: center; background-repeat: no-repeat;">
