...
@section('page_title', $category->name . ' ' . __('voyager::bread.order'))

@section('page_header')
<h1 class="page-title">
    <i class="voyager-list"></i>{{ $category->name }} {{ __('voyager::bread.order') }}
</h1>
@stop
...
$(document).ready(function () {
    ...
    */
    $('.dd').on('change', function (e) {
        $.post('{{ route('voyager.'.$dataType->slug.'.order', [$categoryId]) }}', {
